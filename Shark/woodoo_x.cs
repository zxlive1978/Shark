    ...
    public class woodoo_x
    {
       ...
       //Первое новое значение a1new
        ...
        public void init(){
            ...
            foreach(char ch in text_char )
            str.Append(ch);
            text_print = str.ToString();
        }
